...
| `TwoWire has not been declared` | wrong file opened in Arduino IDE | open the generated single-file sketch (`SMART-DEHUMIDIFIER-single-file.ino`), not a single .cpp |
