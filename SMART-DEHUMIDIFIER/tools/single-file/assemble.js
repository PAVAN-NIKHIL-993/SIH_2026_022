...
const outDir  = variant === 's3' ? 'SMART-DEHUMIDIFIER-s3-single-file' : 'SMART-DEHUMIDIFIER-single-file';
const outFile = variant === 's3' ? 'SMART-DEHUMIDIFIER-s3-single-file.ino' : 'SMART-DEHUMIDIFIER-single-file.ino';
