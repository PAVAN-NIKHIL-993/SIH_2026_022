...
<style>
 ...
 table{border-collapse:collapse;margin-top:10px;background:rgba(19,48,142,.88)}
 td,th{border:1px solid rgba(233,196,106,.35);padding:8px 12px;text-align:center;font-size:15px}
 th{color:#d6def4;font-size:11px}
 .pressed{background:linear-gradient(135deg,#f6dd9c,#b8862b);color:#2b1a02;font-weight:700}
</style></head><body>
<h1>Keypad test</h1>
<div class="sub">smart dehumidifier &middot; keypad-test &middot; refreshes 1/s &middot; verdict <span id="st" class="tag">...</span></div>
