...
matching SVG previews. Run from smart-dryer/:  python3 tools/make-design-diagram.py
"""
import os
...
p2_boxes = [
 ...
 B('offbox', 'BUTTON-1: hold 3 s = HARD OFF (latch drops) · hold 10 s = REBOOT\nFIRMWARE UPDATE: website → Firmware update (.bin)  or  Arduino IDE → smart-dryer at 192.168.4.1 — refused while RUNNING', 60, 1600, 960, 90, 'note'),
...
p3_boxes = [
 ...
 B('b14', 'ArduinoOTA + mDNS — "smart-dryer"', 60, 936, 300, 50),
